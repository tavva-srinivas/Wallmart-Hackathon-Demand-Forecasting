...
def load_location_data():
    locations_map = pd.read_csv('/content/Wallmart-Hackathon-Demand-Forecasting/locations_map.csv')
    warehouse_store_mapping = pd.read_csv('/content/Wallmart-Hackathon-Demand-Forecasting/final_warehouse_store_mapping.csv')
